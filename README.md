...
- Supports direct Google Sheets write-back through the included Apps Script helper

## Files

- `index.html` - the review app
- `google-sheets-web-app.gs` - optional Google Apps Script helper for writing approvals back to the editable spreadsheet
...
The published Google Sheets link is read-only. To send approvals back to the original sheet:
...
6. Open the review app, choose Sheet Connection, and paste that URL.
